...
import {
  BarChart3, ShoppingBag, Users, Bell, Loader2, Menu, X, ChevronRight, Mail, DollarSign
} from "lucide-react";
...
type Tab = "dashboard" | "orders" | "users" | "notifications" | "leads" | "sales";
      ...
      <div className="flex">
        ...
        <aside className={`fixed left-0 top-[3.5rem] z-50 flex h-[calc(100vh-3.5rem)] w-64 flex-col border-r border-border bg-card transition-transform duration-300 lg:sticky lg:translate-x-0 ${
          ...
          <div className="border-t border-border p-4">
            <p className="text-[10px] text-muted-foreground">Painel Admin v2.0</p>
          </div>
        </aside>
