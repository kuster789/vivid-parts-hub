...
const manuals: ManualItem[] = [
  ...
  {
    title: "Guia de Retentores — Códigos Sabó",
    description: "Guia completo de retentores com códigos Sabó, dimensões e especificações de materiais para Agrale, Yamaha e Honda.",
  ...
  {
    title: "Catálogo de Rolamentos — 2 Rodas",
    description: "Catálogo completo de rolamentos para motocicletas com especificações técnicas, dimensões e referências cruzadas.",
    blogSlug: "catalogo-rolamentos-2-rodas",
    category: "catalogo",
    brand: "Agrale",
    models: ["Agrale", "Yamaha", "Honda"],
    icon: FileText,
  ...
  {
    title: "Two Stroke Performance Tuning — Graham Bell",
    description: "Referência mundial em preparação de motores 2 tempos: termodinâmica, fluxo de gases, escape, admissão e preparação de cilindros.",
    blogSlug: "graham-bell-two-stroke-performance-tuning",
    category: "manual",
    brand: "Agrale",
    models: ["Agrale", "Yamaha"],
    icon: BookOpen,
    coverImage: "/blog/motor-agrale-2tempos-cover.jpg",
  },
  {
    title: "Tabela de Retífica — Motocicletas",
    description: "Tabela completa de retífica com medidas de cilindro, pistão, folgas e limites de desgaste para motocicletas.",
    blogSlug: "tabela-retifica-motocicletas",
    category: "catalogo",
    brand: "Agrale",
    models: ["Agrale", "Yamaha", "Honda"],
    icon: FileText,
  ...
  {
    title: "Manual de Serviço — Agrale 165",
    description: "Manual de serviço oficial da Agrale 165 com procedimentos de manutenção, desmontagem, montagem e especificações técnicas.",
    blogSlug: "manual-servico-agrale-165",
    category: "manual",
    brand: "Agrale",
    models: ["Agrale 16.5"],
    icon: Wrench,
