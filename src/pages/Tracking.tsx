...
import { Package, Truck, CheckCircle, Clock, XCircle, Loader2, Search, Factory, Paintbrush, PackageCheck, Mail, ShoppingBag, ExternalLink } from "lucide-react";
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    {order.tracking_code && (
                      <a
                        ...
                        className="flex items-center gap-1.5 rounded-md bg-primary/10 px-3 py-1.5 font-mono text-[11px] font-bold text-primary transition-colors hover:bg-primary/20"
                      >
