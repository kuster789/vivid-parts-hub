...
const Index = () => {
  ...
  return (
    <main>
      {/* Hero */}
      <section className="dark relative flex min-h-[60vh] items-center overflow-hidden md:min-h-[80vh]" style={{ colorScheme: "dark" }}>
        ...
        <div className="container relative z-10 py-10 md:py-20">
          <div className="max-w-2xl animate-fade-in">
            ...
            <h1 className="mb-4 font-display text-3xl font-black uppercase leading-[1.1] tracking-wide text-white sm:text-4xl md:mb-6 md:text-6xl lg:text-7xl">
              Auto Peças <br /><span className="text-gradient">Agrale</span>
            </h1>
            <p className="mb-6 max-w-lg font-body text-sm leading-relaxed text-gray-400 md:mb-8 md:text-lg">
              Peças e componentes técnicos para motocicletas clássicas e esportivas.
              Qualidade profissional com <span className="font-semibold text-white">visualização 3D interativa</span>.
            </p>
            <div className="mb-8 flex flex-col gap-3 sm:flex-row md:mb-12">
              ...
              <Link to="/suporte" className="inline-flex items-center justify-center gap-2 rounded-lg border border-white/20 bg-white/5 px-6 py-3 text-sm font-medium text-white backdrop-blur-sm transition-colors hover:bg-white/10 hover:border-primary/30 md:px-8 md:py-3.5">
                <Headphones className="h-4 w-4" aria-hidden="true" /> Suporte
              </Link>
            </div>

            {/* Stats */}
            <div className="grid grid-cols-4 gap-4 border-t border-white/10 pt-6 md:flex md:gap-12 md:pt-8">
